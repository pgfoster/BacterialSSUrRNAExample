...
# For these two leaf nodes, it does not matter if it is clade-wize or not.
t.setModelComponentOnNode(B, t.node("Bacillus"))
t.setModelComponentOnNode(B, t.node("Deinococcus"))
